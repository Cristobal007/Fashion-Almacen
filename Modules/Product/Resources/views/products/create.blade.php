                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_order_tax" id="product_order_tax" value="{{ old('product_order_tax') }}" min="0">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
...
@push('page_scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            // Nuevo bloque de código para desactivar el input cuando se selecciona "Inclusivo"
            $('#product_tax_type').change(function () {
                var selectedOption = $(this).val();

                // Verificar si la opción seleccionada es "Inclusivo"
                if (selectedOption === "2") {
                    $('#product_order_tax').prop("disabled", true).val(0);
                } else {
                    $('#product_order_tax').prop("disabled", false);
                }
            });
